...
def export_to_line_chart(filename, data, sheet_name="Sheet1"):
    ...
    chart1.add_series({'values': '=Sheet1!$B$1:$B$'+str(len(data[0])), 'name': 'xz angles', 'line': {'color': 'green'}})
    chart1.add_series({'values': '=Sheet1!$C$1:$C$'+str(len(data[0])), 'name': 'yz angles', 'line': {'color': 'blue'}})
